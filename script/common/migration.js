export const migrateWorld = async () => {
    ...
    const worldSchemaVersion = Number(game.settings.get("only-war", "worldSchemaVersion"));
    if (worldSchemaVersion !== schemaVersion && game.user.isGM) {
        ...
        game.settings.set("only-war", "worldSchemaVersion", schemaVersion);
                    ...
                    // Be extra careful and filter out bad data because the existing data is bugged
                        ...
                        ?.map(textAptitude => {
                            return {
                                ...
                                type: "aptitude",
                                isAptitude: true,
                                img: "systems/only-war/asset/icons/aptitudes/aptitude400.png"
                            };
                        });
